...
SURVEY_MASTER_TEMPLATE = (
    settings.SURVEY_MASTER_TEMPLATE if hasattr(settings, "SURVEY_MASTER_TEMPLATE") else "djf_surveys/master.html"
)

# profile photo path
SURVEY_USER_PHOTO_PROFILE = (
    settings.SURVEY_USER_PHOTO_PROFILE if hasattr(settings, "SURVEY_USER_PHOTO_PROFILE") else ""
)
...
# validators
field_validators = {"max_length": {"email": 150, "text": 250, "url": 250}}
...
number_of_pagination = {"survey_list": 120, "answer_list": 120}
