...
class FusionTable:
    ...
    def CreateFilter(self, filterType, columnName, *values):
        ...
        switcher = {
            FusionTable.FilterType.Equals: "FusionCharts.DataStore.Operators.{0}('{1}', '{2}')".format(
                fx, columnName, my_list[0]
            ),
        ...
        return switcher.get(
            filterType, "FusionCharts.DataStore.Operators.{0}('{1}', {2})".format(fx, columnName, my_list[0])
        )
